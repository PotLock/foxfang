...
export async function finalizeSetupWizard(
  ...
  await prompter.note(
    [
      ...
      "Docs: https://docs.foxfang.ai/concepts/agent-workspace",
    ].join("\n"),
    "Workspace backup",
  );

  await prompter.note(
    "Running agents on your computer is risky — harden your setup: https://docs.foxfang.ai/security",
    "Security",
  );
    ...
    if (!entry) {
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("foxfang configure --section web")}`,
          "",
      ...
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("foxfang configure --section web")}`,
          "",
          `Get your key at: ${entry?.signupUrl ?? "https://docs.foxfang.ai/tools/web"}`,
          "Docs: https://docs.foxfang.ai/tools/web",
        ].join("\n"),
        "Web search",
      );
      ...
      await prompter.note(
        [
          ...
          `Re-enable: ${formatCliCommand("foxfang configure --section web")}`,
          "",
          "Docs: https://docs.foxfang.ai/tools/web",
        ].join("\n"),
        "Web search",
  ...
  await prompter.note(
    'What now: https://foxfang.ai/showcase ("What People Are Building").',
    "What now",
  );
