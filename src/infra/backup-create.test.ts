  ...
  it.each([
    {
      ...
      expected: [
        ...
        "- state: ~/.foxfang",
        "Skipped 1 path:",
        "- workspace: ~/Projects/openclaw (covered by ~/.foxfang)",
        ...
        assets: [
          {
            ...
            displayPath: "~/.foxfang/config.json",
          },
          {
            kind: "credentials",
            sourcePath: "/oauth",
            archivePath: "archive/oauth",
            displayPath: "~/.foxfang/oauth",
          },
        ],
      }),
      expected: [
        backupArchiveLine,
        "Included 2 paths:",
        "- config: ~/.foxfang/config.json",
        "- credentials: ~/.foxfang/oauth",
