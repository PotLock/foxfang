...
read_when:
  - 设置 macOS 开发环境
summary: 为在 FoxFang macOS 应用上工作的开发者提供的设置指南
title: macOS 开发设置
x-i18n:
...
本指南涵盖从源代码构建和运行 FoxFang macOS 应用程序的必要步骤。
...
要构建 macOS 应用并将其打包到 `dist/FoxFang.app`，运行：
...
macOS 应用期望全局安装 `foxfang` CLI 来管理后台任务。
