...
openclaw agents add work --workspace ~/.foxfang/workspace-work
openclaw agents set-identity --workspace ~/.foxfang/workspace --from-identity
...
- 示例路径：`~/.foxfang/workspace/IDENTITY.md`
