...
Script: [`scripts/bench-model.ts`](https://github.com/foxfang/foxfang/blob/main/scripts/bench-model.ts)
...
Script: [`scripts/bench-cli-startup.ts`](https://github.com/foxfang/foxfang/blob/main/scripts/bench-cli-startup.ts)
