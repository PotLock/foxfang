...
Spotted an attack vector or risk we haven't covered? Open an issue on [foxfang/trust](https://github.com/foxfang/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.
...
- **Threat model questions:** Open an issue on [foxfang/trust](https://github.com/foxfang/trust/issues)
