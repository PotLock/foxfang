      ...
      <div className="w-full max-w-md bg-bg-secondary border border-border-default rounded-xl p-12 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            />
            <p className="text-xs text-text-muted mt-1">Get token from SETUP_PASSWORD env or gateway setup</p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-border-muted text-center">
          <p className="text-sm text-text-secondary">
            Set token via{' '}
            <code className="px-1.5 py-0.5 bg-bg-tertiary rounded text-xs">SETUP_PASSWORD</code>{' '}
            or{' '}
            <code className="px-1.5 py-0.5 bg-bg-tertiary rounded text-xs">FOXFANG_UI_TOKEN</code>{' '}
            env variable
          </p>
        </div>
      </div>
