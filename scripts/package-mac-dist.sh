...
# Output:
# - dist/FoxFang.app
# - dist/FoxFang-<version>.zip
# - dist/FoxFang-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.foxfang.mac}"
...
ZIP="$ROOT_DIR/dist/FoxFang-$VERSION.zip"
DMG="$ROOT_DIR/dist/FoxFang-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FoxFang-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FoxFang-$VERSION.dSYM.zip"
