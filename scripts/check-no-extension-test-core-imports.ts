...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']foxfang\/plugin-sdk["']/,
    hint: "Use foxfang/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']foxfang\/plugin-sdk\/test-utils["']/,
    hint: "Use foxfang/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']foxfang\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or foxfang/plugin-sdk/testing for public surfaces.",
  },
  {
